...
def endcode_data(data, outputs_dir, latent_space):
    ...
    methods = [AnalyticalPCA(),
               NumericMinimizationPCA(plots_dir, optimization_steps=10000, regularization_factor=10),
               VanilaAE(plots_dir, optimization_steps=10000),
               ALAE(plots_dir, optimization_steps=10000)]
...
if __name__ == '__main__':
    ...
    data, labels, dataset_name = get_mnist()
